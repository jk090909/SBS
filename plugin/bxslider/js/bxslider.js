...
$(document).ready(function(){
    $('.slider').bxSlider({
        ...
        startSlide: 0, //? default : 0. 시작시에 노출 될 slide index 설정.
        randomStart: false, //? default : false. slide 순서를 random으로 전환.
        //! 둘은 겹치기때문에 하나를 꺼야됨 -> if randomStart : true -> startSlide delete.
        ...
        //* adaptiveHeight
        adaptiveHeight: true, //? default : false. slide내 img의 높이에 따라 frame 높이 변환.
        adaptiveHeightSpeed: 750, //? default : 500. adaptiveHeight가 적용되는 시간.

        easing: 'ease-in-out', //? default : null. slide 전환 가속도. CSS timing-funtion option 사용가능.
        captions: true, //? default : false. img에 title Attr을 img 위에 띄워주기.
        video: true, //! default : false. viedeo 미사용시 절때 활성화 하지 말것.
        ...
        //? pagerSelector: '.newPager' pagerCutom - 1 번 : default: '', pager 공간 생성 및 기본 틀 제공
